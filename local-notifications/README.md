...
| **`timeSensitive`**    | <code>boolean</code>                          | If true, marks the notification as "time sensitive" on iOS. Requires Time Sensitive notification entitlement to be enabled. Only available for iOS.                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | 4.0.0 |
